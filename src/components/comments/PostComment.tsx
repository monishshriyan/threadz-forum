...
import { Button } from "../ui/Button"; // Assuming Button component is correctly updated with isLoading prop
...
const PostComment: FC<PostCommentProps> = ({
  ...
  const { mutate: postComment, isLoading } = useMutation({
    // isLoading is already available here
        ...
        <div className="grid w-full gap-1.5 mt-4">
          ...
          <div className="mt-2">
            ...
            <div className="mt-2 flex justify-end gap-2">
              ...
              >
                {isLoading ? ( // Conditional rendering for button content
                  <>
